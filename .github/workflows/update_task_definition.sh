...
#Update logConfiguration awslogs-group value in the task-definition.json file
sed -i 's/"awslogs-group": "/ecs/awslogs/Crankbit-cluster-main"/"awslogs-group": "/ecs/awslogs/Crankbit-cluster-'"$ENVIRONMENT"'"/' .github/workflows/task_definition.json
