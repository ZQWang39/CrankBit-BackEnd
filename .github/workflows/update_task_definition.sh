...
sed -i 's/349498089405.dkr.ecr.ap-southeast-2.amazonaws.com\/crankbit-backend-main:latest/349498089405.dkr.ecr.ap-southeast-2.amazonaws.com\/crankbit-backend-'"$ENVIRONMENT"':'"$GITHUB_SHA"'/g' .github/workflows/task-definition.json
